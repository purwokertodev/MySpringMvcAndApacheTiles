            ...
            for (var i=depth; i>0; --i) {
                ...
                if (i > 1) {
                    RGraph.path(
                        ...
                        [
                         'b',
                         'a', this.centerx, this.centery, this.radius + 1, 0, (ma.PI * 2) * prop['chart.effect.roundrobin.multiplier'], false,
                        ]
                    );
                    ...
                    if (prop['chart.variant'].indexOf('donut') !== -1) {
                        RGraph.path(
                            this.context,
                            [
                             'a', this.centerx, this.centery, this.radius / 2, (ma.PI * 2) * prop['chart.effect.roundrobin.multiplier'], 0, true,
                             'f', 'rgba(0,0,0,0.1)'
                            ]
                        );
                    ...
                    // Draw the path on to the canvas
                        ...
                        RGraph.path(this.context,['f', 'rgba(0,0,0,0.1)']);
                    }
                }
            }
